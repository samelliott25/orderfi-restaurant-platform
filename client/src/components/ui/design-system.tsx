...
export const OrderFiHeading = ({ 
  ...
  const baseClasses = 'orderfi-heading bg-gradient-to-r from-[#F5A623] via-orange-500 to-pink-500 bg-clip-text text-transparent';
...
export const OrderFiButton = ({ 
  ...
  const gradientClasses = gradient 
    ? 'bg-gradient-to-r from-[#F5A623] via-orange-500 to-pink-500 hover:from-[#E6951F] hover:via-orange-600 hover:to-pink-600 text-white border-none'
    : '';
