...
export function CustomerAiChat({ isOpen, onToggle, onAddToCart, currentCart = [] }: CustomerAiChatProps) {
  ...
  return (
    <div 
      className="fixed bottom-6 right-24 z-50 w-96 h-[500px] rounded-2xl shadow-2xl border border-white/20 animate-in slide-in-from-bottom-4 duration-300 relative overflow-hidden"
      style={{
