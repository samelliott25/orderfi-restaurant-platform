  ...
  return (
    <>
      ...
      <div className="w-full h-full rounded-[28px] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.25)] backdrop-blur-[20px] border border-white/20"
        ...
        <div className="relative px-6 py-4 border-b border-white/20 backdrop-blur-md rounded-t-[28px]">
        ...
        <div className="relative px-4 py-3 border-t border-white/20 backdrop-blur-md rounded-b-[28px]">
          <div className="flex items-center space-x-3">
