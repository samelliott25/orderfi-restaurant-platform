    ...
    <div className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[200] ${className}`}>
      <div className="relative">
        <button
          ...
          style={{
            background: `
              radial-gradient(circle at 30% 30%, rgba(245, 166, 35, 0.9) 0%, transparent 60%),
              radial-gradient(circle at 70% 70%, rgba(249, 115, 22, 0.8) 0%, transparent 60%),
              radial-gradient(circle at 50% 50%, rgba(236, 72, 153, 0.7) 0%, transparent 70%)
            `,
          }}
        >
          {/* Cascading sparkles */}
