  ...
  return (
    <div className={`flex items-center justify-center ${className}`}>
      <div className="relative">
        {/* Main OrderFi Text */}
        <div className={`text-6xl md:text-7xl lg:text-8xl font-bold font-heading text-orange-500 transition-all duration-1000 ${
        ...
        {/* Fallback text for browsers that don't support gradient text */}
        <div 
          className={`absolute inset-0 text-6xl md:text-7xl lg:text-8xl font-bold font-heading text-orange-500 transition-all duration-1000 ${
            isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-4'
          }`}
          style={{
            zIndex: -1,
