      ...
      <div className="fixed bottom-6 left-0 right-0 bg-transparent pointer-events-none">
        ...
        <div className={`flex justify-center pointer-events-auto z-[200] ${
          ...
          <Button
            ...
            className={`w-20 h-20 rounded-full border-0 bg-transparent hover:bg-white/10 transition-all duration-300 ${
              isAnimating ? 'pointer-events-none' : ''
            }`}
            style={{ transform: 'translateY(-8px)' }}
          >
            {/* Simple trigger - no visual orb here */}
            <div className="w-full h-full rounded-full border border-white/30 bg-white/5 backdrop-blur-sm flex items-center justify-center">
